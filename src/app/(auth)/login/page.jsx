  ...
  return (
    <div className='grid sm:grid-cols-12 '>
      <div className='hidden md:block  md:col-span-6 lg:col-span-8 '>
        <Image src={loginImage} alt='login image' className='size-full' />
      </div>
      <div className='col-span-12 md:col-span-6 lg:col-span-4 p-5 mt-32 mx-auto max-w-lg w-full'>
        <h1 className='text-2xl my-10 text-center '>Sign In now! 😁😁</h1>
        <Form {...form}>
        ...
        <Link
          href='/register'
          className='mt-10 inline-block hover:text-blue-500 text-sm'
        >
